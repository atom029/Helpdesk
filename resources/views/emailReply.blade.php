                          ...
                          <td class="panel">
                           ...
                           @foreach($data1 as $val)
                                  @foreach($file as $f)
                                    ...
                                    <a class="upl_file" href="{{asset('upload')}}/{{session('user')}}/{{$f->file_upload_ticket_id}}/{{$f->file_upload_name}}">File</a><br>
                                    @endif
                                  @endforeach
                            @endforeach
