						...
						<tbody>
							@foreach($data as $val)
								<tr >
									...
									@endif
									<td>
										<button class="btn btn-success btn_edit " >View</button>
									</td>
								</tr>
							@endforeach
						</tbody>
		...
		<div class="col-lg-4" >
			<div id="accordion" class="card-accordion">
				<div class="card">
					...
					<!-- begin card -->
					<div class="card-header bg-black text-white pointer-cursor collapsed" data-toggle="collapse" data-target="#collapse2">
						Agent Information
					</div>
							...
							<div class="panel-body">
									...
									<div class="row">
										<div class="col-lg-12">
											<div class="row">
												<h5>Name:</h5>
												<p id="name">&nbsp&nbsp </p>
											</div>
										</div>
										<div class="col-lg-12">
											<div class="row">
												<h5>SLA:</h5>
												<p id="sla">&nbsp&nbsp </p>
										...
										<div class="col-lg-12">
											<div class="row">
												<h5>Open Ticket:</h5>
												<p id="open">&nbsp&nbsp </p>
											</div>
										</div>
										<div class="col-lg-12">
											<div class="row">
												<h5>Answered Ticket:</h5>
												<p id="answered">&nbsp&nbsp </p>
											</div>
										</div>
										<div class="col-lg-12">
											<div class="row">
										...
										<div class="col-lg-12">
											<div class="row">
												...
												<h5>Overdue:</h5>
												<p id="overdue">&nbsp&nbsp </p>
											</div>
										</div>
										<button class="btn btn-success" id="btn_view_agent">View Tickets</button>
									</div>
...
<script>
	...
	$("#btn_view_agent").on('click',function(){
		$agent = $("#txt_ticket_id").val()
		window.location.href = '{{url('agentTicket') }}/ '+$agent+''
	})

	$(".btn_edit").on('click',function(){
		$('#collapseInfo').removeClass('show');
		$('#collapse2').addClass('show');
		agent_id = $(this).closest("tbody tr").find("td:eq(0)").html()
		$("#txt_ticket_id").val(agent_id)
		name = $(this).closest("tbody tr").find("td:eq(1)").html()
		$.ajax({
                url:'{{route('agentInfo')}}',
                type:'POST',
                ...
                {
                	document.getElementById("name").innerHTML =  "&nbsp&nbsp" + name
                	document.getElementById("sla").innerHTML  =  "&nbsp&nbsp" +data['sla']
                	document.getElementById("open").innerHTML =  "&nbsp&nbsp" +data['open']
                	document.getElementById("closed").innerHTML =  "&nbsp&nbsp" +data['closed']
                	document.getElementById("answered").innerHTML = "&nbsp&nbsp" + data['answered']
                	document.getElementById("overdue").innerHTML =  "&nbsp&nbsp" +data['overdue']
